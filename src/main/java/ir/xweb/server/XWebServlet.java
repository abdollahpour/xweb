...
public class XWebServlet extends HttpServlet {
	...
	private static final Logger logger = LoggerFactory.getLogger("XWebServlet");

	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		
		final Manager manager = (Manager) getServletContext().getAttribute(Constants.SESSION_MANAGER);
